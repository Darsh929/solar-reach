...
export default function Home() {
  ...
  return (
    <>
      <div
        className={`flex min-h-screen min-w-screen flex-col items-center justify-center gap-16 overflow-hidden p-8 pb-20 font-[Cantarell] text-(--background) transition-colors duration-1000 sm:p-20 ${isLightOn ? "" : ""}`}
        onClick={animate}
      ...
      >
        <div className="mt-28 sm:hidden">
          ...
          >
            ...
            <path
              className="stroke-(--light-4) stroke-12"
              d="M 256 94 l 0 -2000"
            />
          </svg>
        </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-8 sm:-mt-[70px] sm:items-start">
          <h2 className="mx-auto max-w-(--breakpoint-md) text-center text-2xl font-extrabold text-(--background) sm:text-3xl">
            Brightening futures with solar
          </h2>
          <p className="mx-auto max-w-(--breakpoint-md) text-center text-lg font-medium text-(--background) sm:text-xl">
