          ...
          <motion.nav initial={false} animate={isHovered ? "open" : "closed"}>
            <motion.ul
              variants={{
                ...
                closed: {
                  clipPath: "inset(10% 20% 100% 100% round 10px)",
                  transition: {
                    type: "spring",
                    bounce: 0,
                    duration: 3,
              ...
              className="space-y-1 px-4 pt-0 pb-3 backdrop-blur-xs"
            >
